...
if [[ $HHVM == "true" ]]; then
    ...
    sudo apt-get install -qq php7.0 php7.0-cli php7.0-fpm php7.0-mysql php7.0-pgsql php7.0-sqlite php7.0-curl php7.0-gd php7.0-intl php-xdebug php-zip php7.0-xml php7.0-mbstring 
